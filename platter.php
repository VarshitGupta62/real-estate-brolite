...
<!-- content begin -->
        <div id="content" class="no-bottom no-top">
            ...
            <section class="banner-sec">
                <div class="banner-img">
                    ...
                    <img class="img-fluid" src="assets/images/slider/residential.jpg" alt="Top Property in gurgaon	">
            ...
            <section id="section-portfolio" class="no-top no-bottom properties" aria-label="section-portfolio">
                <div class="container">
                    ...
                    <div class="row">
                        <div class="col-md-6 offset-md-3 text-center wow fadeInUp">
                            <h1>Top Residential Properties </h1>
                ...
                <div class="container-fluid">
                    <div id="" class="row changeNew gallery wow fadeInUp" data-wow-delay=".3s">
     <div class="col-md-3 col-sm-6 item">
        <div class="picframe properties-inner">
            <a href="residential/ambience-tiverton.html">
                <span class="overlay">
                    <span class="pf_text">
                        <span class="project-name">Ambience Tiverton</span>
                </span>    
            </span>
            </a>
    ...
    </div> <div class="col-md-3 col-sm-6 item">
        <div class="picframe properties-inner">
        ...
        <div class="picframe properties-inner">
            <a href="residential/godrej-tropical-isle.html">
                <span class="overlay">
                    <span class="pf_text">
        ...
        <div class="picframe properties-inner">
            ...
            <span class="overlay" onclick="window.open(`https://www.propertyfinder.org.in/residential/experion-elements`,`_blank`) ">
                <span class="pf_text">
        ...
        <div class="picframe properties-inner">
            <a href="residential/legacy-by-gaurs.html">
                <span class="overlay">
                    <span class="pf_text">
